...
<div class='cs-settings-container'>
	...
	<div class="crowdsignal-setup__content">
		<div class="crowdsignal-setup__description">
				...
				<p><?php echo wp_kses_post( __( 'To collect and manage responses you need to connect the plugin to <a href="https://crowdsignal.com">Crowdsignal</a>. <br />It will take less than a minute and it’s free.', 'crowdsignal-forms' ) ); ?></p>
		</div>
